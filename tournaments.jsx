...
function Tournaments({ onNavigate }) {
  ...
  const tournaments = [
    ...
    { id: "tour-mic-punta-cana", featured: true, name: "MIC Punta Cana", meta: "Dominican Republic · Jun 24–29 2026", img: "https://cdn.builder.io/api/v1/image/assets%2F94fd70ad307f4ddc9cac607abab780ad%2F201c796488b54cc5b7ede7c01b6937bb?format=webp&width=800&height=1200", desc: "MIC goes to the Caribbean. Same quality, same clubs, different location. All-inclusive resort setting with 13 natural grass pitches at The Fields Cap Cana Sports City.", facts: [["Age", "U12 — U16"], ["Format", "Group + KO"], ["Location", "Caribbean"], ["Window", "June"]] },
  ];

...
const EXP_DATA = {
  "exp-nxgenpro": {
    ...
    itinerary: [
      { day: "DAY 01", title: "Arrival & Induction", time: "Full day", desc: "Arrive at Gordon's School and check into Augusta Boarding House. Meet your NXGEN resident coaches and support staff. Complete induction tour of the £6 million sports hub, including the 1,233 m² indoor sports hall, 150 m² air-conditioned fitness suite, and all football pitches and recovery facilities. Team dinner and briefing on the week's schedule, coaching philosophy, and expectations." },
      { day: "DAY 02", title: "Technical Foundation & Match Preparation", time: "Full day", desc: "Breakfast. Morning technical training session focusing on ball mastery, dribbling under pressure, and finishing techniques under professional coaching. Lunch. Afternoon session on tactical awareness and decision-making in game situations. Evening: Video analysis of your team's recent performance and tactical review specific to your squad's playing style and development focus." },
      { day: "DAY 03", title: "Intensity Build & Competitive Fixture", time: "Full day", desc: "Breakfast. High-intensity technical and tactical training session at Gordon's School pitches. Advanced work on pressing, counter-attacks, and positional intelligence. Lunch. Competitive friendly match against local academy opposition — your players experience real match situations with professional-standard opposition. Evening: Recovery session in the 150 m² fitness suite and individual feedback from coaches." },
      { day: "DAY 04", title: "Physical Development & Strength Work", time: "Full day", desc: "Breakfast. Strength and conditioning session in the brand-new air-conditioned fitness suite focusing on explosive power, core stability, and injury prevention. Tactical training on team shape and defensive principles. Lunch. Afternoon competitive friendly match. Evening: Swimming pool and recovery work, with 1-on-1 player talks and individual development plans with coaching staff." },
      { day: "DAY 05", title: "Advanced Tactical & Game Application", time: "Full day", desc: "Breakfast. Advanced tactical training on complex game scenarios, transition play, and shape management under pressure. Match simulation in real conditions. Lunch. Competitive friendly fixture. Evening: Video analysis of today's match performance with focus on decision-making, positioning, and tactical execution." },
      { day: "DAY 06", title: "Finishing & Performance Review", time: "Full day", desc: "Breakfast. Final intensive training session on finishing techniques, clinical conversion, and set-piece delivery. Lunch. Competitive friendly match. Evening: Formal performance review with each player — individual feedback, development areas, and recommendations for continued growth. Team debrief and celebration of the week's progress." },
      { day: "DAY 07", title: "Departure & Debrief", time: "Morning", desc: "Breakfast. Final light training session and team debrief. Collect player feedback and engagement survey. Departure from Gordon's School with takeaway player assessment reports and video highlights from the week." },
    ],
    sections: [
  ...
  "exp-levante": {
    ...
    itinerary: [
      { day: "DAY 01", title: "Arrival & Accommodation", time: "Full day", desc: "Arrival at Valencia Airport. Transfer to Global-Levante UD International Residence. Hotel check-in and orientation. Full board: breakfast, lunch, dinner included. Welcome meeting with tutoring staff." },
      { day: "DAY 02", title: "First Training · Friendly Match", time: "Full day", desc: "Breakfast. Transfer to Levante UD training facility. Introduction with Levante coaching staff. Morning and afternoon training sessions under Levante methodology. Lunch at academy. Friendly match at Levante UD training ground in Buñol against same age category opposition. Return to residence for dinner." },
      { day: "DAY 03", title: "Training · Individual Talks · Stadium Tour", time: "Full day", desc: "Breakfast. Training session with Levante coaching staff. Lunch at academy. Individual player talks and feedback with coaches. Laundry service available. Guided tour of Levante UD's Ciutat de Valencia stadium — press room, museum, changing rooms, shop, pitch access. Return to residence for dinner." },
      { day: "DAY 04", title: "Training · Video Analysis · Friendly Match", time: "Full day", desc: "Breakfast. Training session at Levante UD facility. Lunch at academy. Video analysis of recent performance and tactical review. Transfer to friendly match against academy opponent at Levante UD training ground. Return to residence for dinner." },
      { day: "DAY 05", title: "Training · City of Arts & Sciences Excursion", time: "Full day", desc: "Breakfast. Training session with Levante coaching staff. Lunch at academy. Guided excursion to Valencia's City of Arts and Sciences — tour of emblematic buildings and their importance in modern Valencia architecture. Return to residence for dinner." },
      { day: "DAY 06", title: "Training · Individual Talks · Cultural Visit", time: "Full day", desc: "Breakfast. Training session at academy. Lunch at academy. Individual player talks and feedback. Guided tour of Valencia's historic center (Ciutat Vella) — explore architectural wonders, cultural attractions, and shopping areas. Return to residence for dinner." },
      { day: "DAY 07", title: "Final Training · Departure", time: "Morning/Afternoon", desc: "Breakfast. Final training session with Levante coaching staff. Hotel checkout. Transfer to Valencia Airport for departure." },
    ],
    sections: [
  ...
  "exp-betis": {
    ...
    itinerary: [
      { day: "DAY 01", title: "Arrival · Friendly Match", time: "Full day", desc: "Arrival in Seville and hotel check-in. Welcome briefing with Real Betis coaching staff. Afternoon friendly match against Real Betis academy opposition." },
      { day: "DAY 02", title: "Morning Training · Afternoon Training", time: "Full day", desc: "Breakfast. Morning training session at Rafael Gordillo Sport Facility under Real Betis coaching staff. Lunch. Afternoon training session focusing on tactical principles and technical development." },
      { day: "DAY 03", title: "Morning Training · Friendly Match", time: "Full day", desc: "Breakfast. Morning training at Rafael Gordillo Sport Facility. Lunch. Afternoon friendly match against Real Betis academy opposition." },
      { day: "DAY 04", title: "Morning Training · Afternoon Training", time: "Full day", desc: "Breakfast. Morning training session at Rafael Gordillo. Lunch. Afternoon training with emphasis on set-piece and positional work." },
      { day: "DAY 05", title: "Morning Training · Free Time", time: "Full day", desc: "Breakfast. Morning training session at Rafael Gordillo Sport Facility. Lunch. Afternoon free time to explore Seville — the city's Andalusian culture and architecture are part of the experience." },
      { day: "DAY 06", title: "Morning Training · VIP Stadium Tour", time: "Full day", desc: "Breakfast. Morning training at Rafael Gordillo. Lunch. VIP tour of Estadio Benito Villamarín — press room, museum, changing rooms, shop, and stepping on the pitch. Historical talk about Real Betis identity and values." },
      { day: "DAY 07", title: "Free Time · Departure", time: "Morning/Afternoon", desc: "Breakfast. Free time or optional activity. Hotel checkout. Transfer to airport for departure." },
    ],
    sections: [
  ...
  "exp-feyenoord": {
    ...
    itinerary: [
      { day: "DAY 01", title: "Arrival · Stadium Experience", time: "Full day", desc: "Arrival at Schiphol Airport. Transfer to hotel and check-in. Lunch at the hotel. Transfer to the stadium to watch Feyenoord match. Return to hotel for dinner." },
      { day: "DAY 02", title: "Introduction · Training · Friendly Match", time: "Full day", desc: "Breakfast. Transfer to Feyenoord Academy. Introduction with Feyenoord coaching staff. Morning and afternoon training sessions. Lunch at academy. Friendly match against academy opponent. Return to hotel for dinner." },
      { day: "DAY 03", title: "Training · Individual Talks · Stadium Tour", time: "Full day", desc: "Breakfast. Training with Feyenoord coaching staff. Lunch at academy. Individual player talks & feedback. Laundry pickup. Guided tour of Feyenoord Stadium. Visit Feyenoord fan shop. Return to hotel for dinner." },
      { day: "DAY 04", title: "Training · Video Analysis · Friendly Match", time: "Full day", desc: "Breakfast. Training at academy. Walk to Feyenoord Stadium. Lunch at stadium. Video analysis of recent performance. Laundry drop-off. Return to hotel for dinner. Transfer to friendly match against academy opponent." },
      { day: "DAY 05", title: "Training · City Exploration", time: "Full day", desc: "Breakfast. Training at academy. Lunch at academy. Afternoon training session. Laundry pickup. Guided city walk in downtown Rotterdam. Dinner at Very Italian Pizza restaurant. Return to hotel." },
      { day: "DAY 06", title: "Training · Individual Talks · Watch Match", time: "Full day", desc: "Breakfast. Training at academy. Lunch at academy. Individual player talks & feedback. Afternoon training session. Return to hotel for dinner. Transfer to KKD match to watch professional football. Return to hotel." },
      { day: "DAY 07", title: "Final Training · Departure", time: "Morning", desc: "Breakfast. Final training session at Feyenoord Academy. Transfer back to hotel. Transfer to Schiphol Airport and departure." },
    ],
    sections: [
          ...
          <div className="itin">
            {d.itinerary && d.itinerary.length > 0 ? (
              d.itinerary.map((day, i) => (
                <div key={i} className="itin-day"><div className="itin-day__n">{day.day}</div><div><div className="itin-day__title">{day.title}</div><div className="itin-day__time">{day.time}</div></div><div className="itin-day__desc">{day.desc}</div></div>
              ))
            ) : (
              <>
                <div className="itin-day"><div className="itin-day__n">DAY 01</div><div><div className="itin-day__title">The Foundations</div><div className="itin-day__time">15:00 – 22:00</div></div><div className="itin-day__desc">Arrival and welcome. Introduction meeting on camp purpose: immersing players in a professional football environment. NXGEN kit distribution. Individual player media session. Player ability testing using AiScout technology. Free time and lights out.</div></div>
                <div className="itin-day"><div className="itin-day__n">DAY 02</div><div><div className="itin-day__title">Technical Excellence</div><div className="itin-day__time">09:00 – 22:00</div></div><div className="itin-day__desc">Mental preparation and visualisation. Technical skills drills — ball mastery, dribbling under pressure, finishing techniques. Tactical awareness & decision-making. Psych-social development workshop on leadership & teamwork. Small-sided training games. Individual feedback on physical & mental well-being. Live match with Premier League scouts present.</div></div>
                <div className="itin-day"><div className="itin-day__n">DAY 03</div><div><div className="itin-day__title">Game Application</div><div className="itin-day__time">09:00 – 22:00</div></div><div className="itin-day__desc">Higher intensity technical drills. Advanced tactical training — overloads, pressing, counter-attacks. Strength & conditioning for explosiveness and match endurance. Match simulation in real game environments. Post-match recovery techniques. Live fixture with Premier League scouts present.</div></div>
                <div className="itin-day"><div className="itin-day__n">DAY 04</div><div><div className="itin-day__title">Areas for Growth</div><div className="itin-day__time">09:00 – 22:00</div></div><div className="itin-day__desc">Mental preparation focusing on individual development goals. Personalised technical sessions — position-specific skill work. Tactical training & game understanding. Psych-social development on mindset mastery & mental toughness. Small-sided games with individual development focus. Player care session with career pathway advice. Guest speaker from professional football. Live fixture with Premier League scouts present.</div></div>
                <div className="itin-day"><div className="itin-day__n">DAY 05</div><div><div className="itin-day__title">Performance</div><div className="itin-day__time">09:00 – 22:00</div></div><div className="itin-day__desc">Technical & tactical training session. Physical development — strength, conditioning, mobility & stability, injury prevention, core strengthening. Psych-social workshop on mental side of football and positive growth mindset. Tactical training — team shape, transitioning, defensive/offensive principles. Player care check-ins on progress & support. Live fixture with Premier League scouts present.</div></div>
                <div className="itin-day"><div className="itin-day__n">DAY 06</div><div><div className="itin-day__title">Review & Reflection</div><div className="itin-day__time">09:00 – 14:00</div></div><div className="itin-day__desc">Team building exercises focused on unity & leadership. Match review & analysis using Veo performance analysis tools. Workshop: Creating a professional career path — actionable steps for progression in football. Camp checkout and departure.</div></div>
              </>
            )}
          </div>
        </div>

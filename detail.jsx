...
const EXP_DATA = {
  ...
  "exp-feyenoord": {
    ...
    sections: [
      ...
      { eyebrow: "06 — Tournament Access", title: "The Netherlands in Easter window — and the Cruyff Tournament.", content: "A Feyenoord-based tour opens up access to the Dutch tournament calendar — including the Cruyff Tournament, hosted in the spirit of Johan Cruyff's footballing philosophy, and the Netherlands Easter Youth Cup and Winter Cup Holland for squads travelling in those windows.\n\nDutch youth football tournaments are known for their organisational quality, competitive standard, and the intensity of the local opposition. The Netherlands produces disproportionate numbers of professional players for its size — the teams your squad will face in competition reflect that.\n\nCruyff Tournament — Netherlands · hosted in the Cruyff philosophy\nNetherlands Easter Youth Cup — Easter window\nWinter Cup Holland — Winter window" },
